...
def test_code():
    ...
    ax.vlines(x=longs, ymin=ymin, ymax=ymax+0.7, color='g', linestyles = 'dashed', linewidth = 1.5)
    ax.vlines(x=shorts, ymin=ymin, ymax=ymax+0.7, color='r', linestyles = 'dotted', linewidth = 1.5)
    ...
    ymin, ymax = ax.get_ylim()
    ax.vlines(x=manuals_longs, ymin=ymin, ymax=ymax+0.7, color='g', linestyles = 'dashed', linewidth = 1.5)
    ax.vlines(x=manuals_shorts, ymin=ymin, ymax=ymax+0.7, color='r', linestyles = 'dotted', linewidth = 1.5)
